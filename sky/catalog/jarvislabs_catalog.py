...
query instance types and pricing information for JarvisLabs.
"""
...
def validate_region_zone(
    ...
    if zone is not None:
        with ux_utils.print_exception_no_traceback():
            raise ValueError('JarvisLabs does not support zones.')
    return common.validate_region_zone_impl('jarvislabs', _df, region, zone)
...
def list_accelerators(
    ...
    """Returns all instance types in JarvisLabs offering GPUs."""
    del require_price  # Unused.
    return common.list_accelerators_impl('JarvisLabs', _df, gpus_only,
